...
- A presentation with speaker notes in three parts: WordPress versus Astro + Payload, prerequisites, and the goal ([view it here](https://claude.ai/artifact/NY9UmLfwZoxMdueYfCgahy)), including a jargon section that names every Astro and Payload term attendees will meet, each beside its WordPress equivalent.
